...
namespace WinFormsApp1.Models
{
    public class Person
    {
        public Person(string? fio, int age, string? group, string? akanam, string? somanam,
            ...
            string? nauseaStatus, string? lungtissueStatus, float pregCoef, float sarsCov2, float fkrpo)
        {
            Age = age;
            Fio = fio;
            Group = group;
        ...
        public float PregCoef { get; set; }
        public float SarsCov2 { get; set; }
        public float Fkrpo { get; set; }
