    ...
    class ExcelHelper
    {
        ...
        public static void SaveAs()
        {
            ...
            try
            {
                ...
                excel.Range["M2"].Value = "Отеки, вызванные беременностью, протеинурия, или вызванные беременностью гипертензия";
                ...
                if (Person.personlist.Count > 0)
                {
                    ...
                    {
                        for (int i = -0; i < Person.personlist.Count;)
                        {
                            for (int j = 0; j < Person.personlist.Count; j++)
                            {
                                excel.Range["A" + i+4].Value = Person.personlist[j].Fio;
                                Debug.WriteLine(person.Fio);
                                excel.Range["B" + i+4].Value = Person.personlist[j].Group;
                                excel.Range["C" + i+4].Value = Person.personlist[j].Age;
                                switch (Person.personlist[j].Akanam)
                                {
                                    case "0":
                                        excel.Range["D" + i+4].Value = 0;
                                        break;
                                    case "1":
                                        excel.Range["E" + i+4].Value = 1;
                                        break;
                                    case "2":
                                ...
                                {
                                    case "0":
                                        excel.Range["G" + i+4].Value = 0;
                                        break;
                                    case "1":
                                        excel.Range["H" + i+4].Value = 1;
                                        break;
                                    case "2":
                                        excel.Range["I" + i+4].Value = 2;
                                        break;
                                }
                                switch (Person.personlist[j].PregnancythreatStatus)
                                {
                                    case "0":
                                        excel.Range["J" + i+4].Value = 0;
                                        break;
                                    case "1":
                                        excel.Range["K" + i+4].Value = 1;
                                        break;
                                    case "2":
                                        excel.Range["L" + i+4].Value = 2;
                                        break;
                                }
                                switch (Person.personlist[j].EdemaStatus)
                                {
                                    case "0":
                                        excel.Range["M" + i+4].Value = 0;
                                        break;
                                    case "1":
                                        excel.Range["N" + i+4].Value = 1;
                                        break;
                                    case "2":
                                        excel.Range["O" + i+4].Value = 2;
                                        break;
                                }
        ...
        public static List<Person> GetPersonData(String _filePath)
        {
            ...
            for (int i = 4; i <= rows; i++)
            {
                ...
                if ((worksheet.Cells[i, 3] as Excel.Range).Value != null){
                  age = (int)(worksheet.Cells[i, 3] as Excel.Range).Value; }
                age = 0;
                string? akanam =
                ...
                float pregCoef = pregCoef = (Convert.ToByte(pregnancythreatStatus) + Convert.ToByte(edemaStatus) +
                ...
                Debug.WriteLine(sarsCov2 + " " + pregCoef + " " + fkrpo);
                if (group == "")
                {
                ...
                var tmpPerson = new Person(fio, age, group, akanam, somanam, pregnancythreatStatus, edemaStatus, preeclampsiaStatus,
                        ...
                        hemodynamicsStatus, saturationStatus, nauseaStatus, lungtissueStatus, pregCoef, sarsCov2, fkrpo);
