...
namespace COVID_Risks
{
...

    {
        ...
        private void PersonList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            ListViewItem PregCoef = new ListViewItem("Коэффицент течения беременности");
            PregCoef.SubItems.Add(Convert.ToString(Person.personlist[selectedIndex].PregCoef));

            ListViewItem SarsCov2 = new ListViewItem("Коэффицент течения SARS-CoV2");
            SarsCov2.SubItems.Add(Convert.ToString(Person.personlist[selectedIndex].SarsCov2));

            ListViewItem Fkrpo = new ListViewItem("Коэффицент риска перинатальных осложнений");
            Fkrpo.SubItems.Add(Convert.ToString(Person.personlist[selectedIndex].Fkrpo));
            ...
            PersonView1.Items.Add(PregCoef);
            PersonView1.Items.Add(SarsCov2);
            PersonView1.Items.Add(Fkrpo);
            ...
            PersonView1.Columns[0].Width = -2;
            PersonView1.Columns[1].Width = -2;
        }
